 ...
 */
 ...
 public class StringProcessingPractice
 {
    ...
    {
        // System.out.println(testGrader("AAA?", "AABA"));
        // System.out.println(letterSwapper("bobo"));
        // System.out.println(letterSwapper("bobob"));
        // System.out.println(caseComparer("Aaa"));
        System.out.println("false " + starChecker("*aaa"));
        System.out.println("true " + starChecker("a*a"));
    }
 }
